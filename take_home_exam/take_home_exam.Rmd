...
In Figure we can see the problem that it is quite difficult to really be sure of convergence by visual analysis. Let us now look at the marginal distribution of the parameters. 
...
The marginal posterior distributions can be seen in Figure ?? for the parameters. 
